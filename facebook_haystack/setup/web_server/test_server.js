...
const client = new cassandra.Client({ contactPoints: [dataStore], keyspace: 'system_auth' });
...
*/
client.execute("SELECT * FROM system_auth.roles;", function (err, result) {
	...
	console.log("Sad! Error occurred.");
	}
